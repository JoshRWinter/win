...
static win::Button keystring_to_button(const char *const keystring)
{
	...
	{
		case keystring_hash("MS1\0"):
			return win::Button::mouse_left;
		case keystring_hash("MS2\0"):
			return win::Button::mouse_right;
		case keystring_hash("MS3\0"):
			return win::Button::mouse_middle;
		case keystring_hash("MS4\0"):
			return win::Button::mouse4;
		case keystring_hash("MS5\0"):
			return win::Button::mouse5;
		case keystring_hash("MS6\0"):
			return win::Button::mouse6;
		case keystring_hash("MS7\0"):
			return win::Button::mouse7;

		case keystring_hash("AC01"):
			return win::Button::a;
		case keystring_hash("AB05"):
			return win::Button::b;
		case keystring_hash("AB03"):
			return win::Button::c;
		case keystring_hash("AC03"):
			return win::Button::d;
		case keystring_hash("AD03"):
			return win::Button::e;
		case keystring_hash("AC04"):
			return win::Button::f;
		case keystring_hash("AC05"):
			return win::Button::g;
		case keystring_hash("AC06"):
			return win::Button::h;
		case keystring_hash("AD08"):
			return win::Button::i;
		case keystring_hash("AC07"):
			return win::Button::j;
		case keystring_hash("AC08"):
			return win::Button::k;
		case keystring_hash("AC09"):
			return win::Button::l;
		case keystring_hash("AB07"):
			return win::Button::m;
		case keystring_hash("AB06"):
			return win::Button::n;
		case keystring_hash("AD09"):
			return win::Button::o;
		case keystring_hash("AD10"):
			return win::Button::p;
		case keystring_hash("AD01"):
			return win::Button::q;
		case keystring_hash("AD04"):
			return win::Button::r;
		case keystring_hash("AC02"):
			return win::Button::s;
		case keystring_hash("AD05"):
			return win::Button::t;
		case keystring_hash("AD07"):
			return win::Button::u;
		case keystring_hash("AB04"):
			return win::Button::v;
		case keystring_hash("AD02"):
			return win::Button::w;
		case keystring_hash("AB02"):
			return win::Button::x;
		case keystring_hash("AD06"):
			return win::Button::y;
		case keystring_hash("AB01"):
			return win::Button::z;

		case keystring_hash("AE10"):
			return win::Button::d0;
		case keystring_hash("AE01"):
			return win::Button::d1;
		case keystring_hash("AE02"):
			return win::Button::d2;
		case keystring_hash("AE03"):
			return win::Button::d3;
		case keystring_hash("AE04"):
			return win::Button::d4;
		case keystring_hash("AE05"):
			return win::Button::d5;
		case keystring_hash("AE06"):
			return win::Button::d6;
		case keystring_hash("AE07"):
			return win::Button::d7;
		case keystring_hash("AE08"):
			return win::Button::d8;
		case keystring_hash("AE09"):
			return win::Button::d9;

		case keystring_hash("TLDE"):
			return win::Button::backtick;
		case keystring_hash("AE11"):
			return win::Button::dash;
		case keystring_hash("AE12"):
			return win::Button::equals;
		case keystring_hash("AD11"):
			return win::Button::lbracket;
		case keystring_hash("AD12"):
			return win::Button::rbracket;
		case keystring_hash("AC10"):
			return win::Button::semicolon;
		case keystring_hash("AC11"):
			return win::Button::apostrophe;
		case keystring_hash("AB08"):
			return win::Button::comma;
		case keystring_hash("AB09"):
			return win::Button::period;
		case keystring_hash("AB10"):
			return win::Button::slash;
		case keystring_hash("BKSL"):
			return win::Button::backslash;

		case keystring_hash("FK01"):
			return win::Button::f1;
		case keystring_hash("FK02"):
			return win::Button::f2;
		case keystring_hash("FK03"):
			return win::Button::f3;
		case keystring_hash("FK04"):
			return win::Button::f4;
		case keystring_hash("FK05"):
			return win::Button::f5;
		case keystring_hash("FK06"):
			return win::Button::f6;
		case keystring_hash("FK07"):
			return win::Button::f7;
		case keystring_hash("FK08"):
			return win::Button::f8;
		case keystring_hash("FK09"):
			return win::Button::f9;
		case keystring_hash("FK10"):
			return win::Button::f10;
		case keystring_hash("FK11"):
			return win::Button::f11;
		case keystring_hash("FK12"):
			return win::Button::f12;

		case keystring_hash("ESC\0"):
			return win::Button::esc;
		case keystring_hash("PRSC"):
			return win::Button::print_scr;
		case keystring_hash("PAUS"):
			return win::Button::pause_break;
		case keystring_hash("INS\0"):
			return win::Button::insert;
		case keystring_hash("DELE"):
			return win::Button::del;
		case keystring_hash("HOME"):
			return win::Button::home;
		case keystring_hash("PGUP"):
			return win::Button::page_up;
		case keystring_hash("PGDN"):
			return win::Button::page_down;
		case keystring_hash("END\0"):
			return win::Button::end;
		case keystring_hash("BKSP"):
			return win::Button::backspace;
		case keystring_hash("RTRN"):
			return win::Button::ret;
		case keystring_hash("KPEN"):
			return win::Button::enter;
		case keystring_hash("LFSH"):
			return win::Button::lshift;
		case keystring_hash("RTSH"):
			return win::Button::rshift;
		case keystring_hash("LCTL"):
			return win::Button::lctrl;
		case keystring_hash("RCTL"):
			return win::Button::rctrl;
		case keystring_hash("LALT"):
			return win::Button::lalt;
		case keystring_hash("RALT"):
			return win::Button::ralt;
		case keystring_hash("SPCE"):
			return win::Button::space;
		case keystring_hash("COMP"):
			return win::Button::menu;
		case keystring_hash("LWIN"):
			return win::Button::lmeta;
		case keystring_hash("RWIN"):
			return win::Button::rmeta;

		case keystring_hash("UP\0\0"):
			return win::Button::up;
		case keystring_hash("LEFT"):
			return win::Button::left;
		case keystring_hash("RGHT"):
			return win::Button::right;
		case keystring_hash("DOWN"):
			return win::Button::down;

		case keystring_hash("CAPS"):
			return win::Button::capslock;
		case keystring_hash("TAB\0"):
			return win::Button::tab;
		case keystring_hash("NMLK"):
			return win::Button::num_lock;
		case keystring_hash("KPDV"):
			return win::Button::num_slash;
		case keystring_hash("KPMU"):
			return win::Button::num_multiply;
		case keystring_hash("KPSU"):
			return win::Button::num_minus;
		case keystring_hash("KPAD"):
			return win::Button::num_plus;
		case keystring_hash("KPDL"):
			return win::Button::num_del;

		case keystring_hash("KP0\0"):
			return win::Button::num0;
		case keystring_hash("KP1\0"):
			return win::Button::num1;
		case keystring_hash("KP2\0"):
			return win::Button::num2;
		case keystring_hash("KP3\0"):
			return win::Button::num3;
		case keystring_hash("KP4\0"):
			return win::Button::num4;
		case keystring_hash("KP5\0"):
			return win::Button::num5;
		case keystring_hash("KP6\0"):
			return win::Button::num6;
		case keystring_hash("KP7\0"):
			return win::Button::num7;
		case keystring_hash("KP8\0"):
			return win::Button::num8;
		case keystring_hash("KP9\0"):
			return win::Button::num9;
	...
	: options(options)
{
	...
	glXCreateContextAttribsARBProc glXCreateContextAttribsARB =
		(glXCreateContextAttribsARBProc)glXGetProcAddress((unsigned char *)"glXCreateContextAttribsARB");
	...
	const int context_attributes[] = { GLX_CONTEXT_MAJOR_VERSION_ARB,
									   ...
									   options.gl_minor,
									   options.debug ? GLX_CONTEXT_FLAGS_ARB : GL_NONE,
									   options.debug ? GLX_CONTEXT_DEBUG_BIT_ARB : GL_NONE,
									   None };
